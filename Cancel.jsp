...
<html lang="en">
      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item"><a href="index.html" class="nav-link" value="<% session.removeAttribute("name");session.removeAttribute("total"); session.removeAttribute("numb");
 %>"><i class="fa fa-sign-out" aria-hidden="true">Logout</i></a></li>
          </ul>
        </div>
      </div>
    </nav>
 ...
 <div style="background:url(images/cancel.gif) no-repeat; background-size: cover;">
 <br><br><br><br>
 
 <h1 align=center style="color:white;"> Your Order has been Cancelled </h1>
 <center><span><a href="specialties.html" class="btn btn-primary btn-outline-primary p-3"><h1>Order Again</h1></a></span></center>
